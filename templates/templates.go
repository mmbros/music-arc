// Generated by /tmp/go-build594712614/command-line-arguments/_obj/exe/gen-templates; DO NOT EDIT
// Creation date: 2016-01-24 00:15:22.553121821 +0100 CET
...
var mTemplates [7]*template.Template

func init() {
	var templatesFiles = [...]string{"_base.tmpl", "_browser-sync.tmpl", "partials/artist.tmpl", "partials/album.tmpl", "album.tmpl", "album-list.tmpl", "partials/artists-list.tmpl", "artist.tmpl", "artists-list.tmpl", "cover/_base.tmpl", "cover/front-10.tmpl", "partials/playlists-list.tmpl", "partials/playlist.tmpl", "playlist.tmpl", "playlists-list.tmpl"}
	var templatesIdxs = [...][]uint8{
		{0, 1, 2, 3, 4},    // album
		{0, 1, 5},          // album_list
		{0, 1, 6, 2, 7},    // artist
		{0, 1, 6, 8},       // artists_list
		{9, 1, 10},         // cover_front_10
		{0, 1, 11, 12, 13}, // playlist
		{0, 1, 11, 14},     // playlists_list
	}
